...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#04A0F3', // how much has loaded
    playRingColor: '#C5F3FA', // how much has played
    backgroundRingColor: '#2462A0', // color shown underneath load + play ("not yet loaded" color)
